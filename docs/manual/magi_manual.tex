...
Small Cu K$\alpha_1$   & $4.903 \pm 0.356$\textsuperscript{$\dagger$} & far over \\
\bottomrule
\end{tabular}
\end{center}

\textsuperscript{$\dagger$}\,\textbf{These two are routing fractions, not
window recoveries.} Cu~K$\alpha_1$ and Cu~K$\alpha_2$ are 21~eV apart, so each
sits inside the other's continuum side-bands and the harness reports the
