...
Source data: S1GDML_DM1.2/allDSCryoSphere_DM1_2_500k_nonu.dat
...
CENTER = (0.0, 0.0, 5.0)      # GDMLDetectorConstruction.cc:167 - NOT the SRON sphere
R = 105.0                     # DSCryoSphereMaxRadius, line 165
...
EPOCHS = 40
LEARNING_RATE = 2e-4
SAVE_DIR = f"/Volumes/X10Pro/MAGI/trained_models/v0_8_2_{SOURCE}"
